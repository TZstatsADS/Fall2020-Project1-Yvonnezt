...
+ The signs and magnitude of the logistic regression coefficients 

The summary(finalmodel) gives the beta coefficients, Standard error, z Value and p Value.

For the variable activities which includes activities levels from 1 (Lowest level) to 6 (Highest level). 
...
Specificity (orFalse Positive Rate) is the percentage of 0’s (actuals) correctly predicted. 
...
+ Which variables will affect the respondents' voting activity?
 + Polling method
...
+ Which group of people will be the most and least active voters in the election?
 + Polling method
